...
export default function QuickActions() {
    return (
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
                { icon: Users, label: 'Freelancers', color: 'text-blue-500', bg: 'bg-blue-50' },
                ...
                return (
                    <button key={action.label} className="bg-white rounded-xl p-6 flex flex-col items-center justify-center gap-3 hover:shadow-lg transition-all group">
